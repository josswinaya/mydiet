...
import { Mail, User, ArrowRight, Leaf } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-bg-app flex flex-col">
      {/* Hero image area */}
      <div className="relative w-full h-48 bg-gradient-to-br from-primary to-primary-hover overflow-hidden flex-shrink-0">

    ...
    <main className="min-h-screen bg-bg-app flex flex-col">
      ...
      <div className="flex-1 -mt-8 relative z-10 rounded-t-[20px] bg-bg-app px-6 pt-8 pb-6 flex flex-col max-w-md mx-auto w-full">
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-xs text-text-muted">Atau masuk dengan</span>
          <div className="flex-1 h-px bg-border" />
        </div>
        ...
        <button
          id="btn-google-login"
          type="button"
          className="w-full flex items-center justify-center gap-3 border border-border rounded-[16px] py-3.5 bg-white text-text-dark text-sm font-medium hover:bg-bg-neutral transition-colors"
        >
